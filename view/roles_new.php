...
<style>
    ...
    /* Role level badges */
    .role-level-1 { background: linear-gradient(135deg, #f3e8ff 0%, #e9d5ff 100%); color: #6b21a8; }
    .role-level-2 { background: linear-gradient(135deg, #dcfce7 0%, #bbf7d0 100%); color: #166534; }
    .role-level-3 { background: linear-gradient(135deg, #dbeafe 0%, #bfdbfe 100%); color: #1e40af; }
    .role-level-4 { background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); color: #92400e; }
    .role-level-5 { background: linear-gradient(135deg, #fee2e2 0%, #fecaca 100%); color: #991b1b; }
    
    /* Department colors */
    .dept-academic { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); }
    .dept-budget { background: linear-gradient(135deg, #84fab0 0%, #8fd3f4 100%); }
    .dept-personnel { background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%); }
    .dept-general { background: linear-gradient(135deg, #ffecd2 0%, #fcb69f 100%); }
        ...
        <div class="container mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
                <div class="glass-effect rounded-xl p-6 card-hover animate-fade-in">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-white">ผู้ใช้ทั้งหมด</h3>
                            <p class="text-3xl font-bold text-blue-600 dark:text-blue-400" id="totalUsers">0</p>
                        </div>
                ...
                <div class="glass-effect rounded-xl p-6 card-hover animate-fade-in">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-white">งานวิชาการ</h3>
                            <p class="text-3xl font-bold text-purple-600 dark:text-purple-400" id="academicCount">0</p>
                        </div>
                ...
                <div class="glass-effect rounded-xl p-6 card-hover animate-fade-in">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-white">งานงบประมาณ</h3>
                            <p class="text-3xl font-bold text-green-600 dark:text-green-400" id="budgetCount">0</p>
                        </div>
                ...
                <div class="glass-effect rounded-xl p-6 card-hover animate-fade-in">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-white">งานบุคคล</h3>
                            <p class="text-3xl font-bold text-orange-600 dark:text-orange-400" id="personnelCount">0</p>
                        </div>
                ...
                <div class="glass-effect rounded-xl p-6 card-hover animate-fade-in">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-white">งานทั่วไป</h3>
                            <p class="text-3xl font-bold text-red-600 dark:text-red-400" id="generalCount">0</p>
                        </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 mb-6 card-hover">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div id="selectedUserInfo" class="bg-gray-50 p-3 rounded-lg hidden">
                        <div class="text-sm text-gray-600">ผู้ใช้ที่เลือก:</div>
                        <div id="userDisplayName" class="font-semibold text-gray-800"></div>
                        <div id="userCurrentRoles" class="text-xs text-gray-500 mt-1"></div>
                    </div>
                </div>
            </div>
...
<div id="permissionModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 w-full max-w-4xl mx-4 max-h-[90vh] overflow-y-auto">
        <div class="flex justify-between items-center mb-4">
            <h3 class="text-xl font-bold text-gray-800 dark:text-white" id="modalTitle">จัดการสิทธิ์เฉพาะ</h3>
            <button id="closePermissionModal" class="text-gray-500 hover:text-gray-700 text-xl">
        ...
        <div class="flex gap-3 mt-6">
            <button id="savePermissions" class="flex-1 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg transition-colors">
                บันทึกสิทธิ์
            </button>
            <button id="cancelPermissions" class="flex-1 bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg transition-colors">
                ยกเลิก
            </button>
        </div>
    </div>
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <select id="modalRole" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                    ...
                    <option value="head">หัวหน้าฝ่าย (4)</option>
                    <option value="officer">เจ้าหน้าที่ (3)</option>
                    <option value="teacher">ครู (2)</option>
                    <option value="viewer">ผู้ชม (1)</option>
                </select>
            </div>
            <div class="flex gap-3 mt-6">
